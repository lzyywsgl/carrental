...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
        ...
        tableIns=table.render({
            ...
            ,url:'${lzywsgl}/rent/loadAllRent.action' //数据接口
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${lzywsgl}/rent/loadAllRent.action?"+params ,
                page:{
                    curr:1
                }
            })
        ...
        table.on('tool(rentTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除【'+data.custname+'】这个出租单吗', function(index){
                    //向服务端发送删除指令
                    $.post("${lzywsgl}/rent/deleteRent.action",{identity:data.identity},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openAddRent(){
            mainIndex=layer.open({
                ...
                success:function(index){
                    //清空表单数据
                    $("#dataFrm")[0].reset();
                    url="${lzywsgl}/rent/addRent.action";
                }
            });
        }
        //打开修改页面
        function openUpdateRent(data){
            mainIndex=layer.open({
                ...
                success:function(index){
                    ...
                    url="${lzywsgl}/rent/updateRent.action";
                }
            });
        }
        //保存
        ...
        function deleteBatch(){
            ...
            layer.confirm('真的删除选中的这些出租单吗', function(index){
                //向服务端发送删除指令
                $.post("${lzywsgl}/rent/deleteBatchRent.action",params,function(res){
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
