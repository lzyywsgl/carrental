    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: '${lzywsgl}/car/loadAllCar.action?isrenting=0' //数据接口
                , title: '车辆据表'//数据导出来的标题
                , height: 'full-220'
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${lzywsgl}/rent/checkCustomerExist.action", params, function (obj) {
                if (obj.code >= 0) {
                    $("#content").show();
                    initCarData();
                } else {
        ...
        function openRentCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $.get("${lzywsgl}/rent/initRentFrom.action", {
                        identity: identity,
                        price: price,
                        carnumber: carnumber
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            $.post("${lzywsgl}/rent/saveRent.action", params, function (obj) {
                layer.msg(obj.msg);
                //关闭弹出层
