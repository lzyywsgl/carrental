...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${lzywsgl}/car/loadAllCar.action' //数据接口
            ...
            , cols: [[   //列表数据
                ...
                , {
                    field: 'isrenting', title: '出租状态', align: 'center', width: '80', templet: function (d) {
                        return !(d.isrenting === 1) ? '<span style="color: red; ">未出租</span>' : '<span style="color: blue; ">已出租</span>';
                    }
                }
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${lzywsgl}/car/loadAllCar.action?" + params,
                page: {
                    curr: 1
                }
            })
        ...
        function openUpdateCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $("#showCarImg").attr("src", "${lzywsgl}/file/downloadShowFile.action?path=" + data.carimg);
                    url = "${lzywsgl}/car/updateCar.action";
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些车辆吗', function (index) {
                //向服务端发送删除指令
                $.post("${lzywsgl}/car/deleteBatchCar.action", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
