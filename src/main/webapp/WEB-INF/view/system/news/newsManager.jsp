...
<head>
    ...
    <link rel="icon" href="${lzywsgl}/static/favicon.ico">
    <link rel="stylesheet" href="${lzywsgl}/static/layui/css/layui.css" media="all"/>
    <link rel="stylesheet" href="${lzywsgl}/static/css/public.css" media="all"/>
    <link rel="stylesheet" href="${lzywsgl}/static/layui_ext/dtree/dtree.css">
    <link rel="stylesheet" href="${lzywsgl}/static/layui_ext/dtree/font/dtreefont.css">
</head>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" autocomplete="off" class="layui-input" title="title">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">公告内容:</label>
            <div class="layui-input-inline">
                <input type="text" name="content" autocomplete="off" class="layui-input" title="content">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="startTime" id="startTime" readonly="readonly" autocomplete="off"
                       class="layui-input" title="startTime">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="endTime" id="endTime" readonly="readonly" autocomplete="off"
                       class="layui-input" title="endTime">
            </div>
        </div>
        <div class="layui-inline">
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'layedit'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${lzywsgl}/news/loadAllNews.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${lzywsgl}/news/loadAllNews.action?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.title + '】这个公告吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${lzywsgl}/news/deleteNews.action", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openAddNews() {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${lzywsgl}/news/addNews.action";
                }
            });
        }
        ...
        function openUpdateNews(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    editIndex = layedit.build('content'); //建立编辑器
                    url = "${lzywsgl}/news/updateNews.action";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些公告吗', function (index) {
                //向服务端发送删除指令
                $.post("${lzywsgl}/news/deleteBatchNews.action", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
