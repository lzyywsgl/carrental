...
<script type="text/javascript">
    var tableIns;
    layui.extend({
        dtree: '${lzywsgl}/static/layui_ext/dist/dtree'
        ...
        tableIns = table.render({
            ...
            , url: '${lzywsgl}/role/loadAllRole.action' //数据接口
        ...
        table.on('tool(roleTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rolename + '】这个角色吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${lzywsgl}/role/deleteRole.action", {roleid: data.roleid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openUpdateRole(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${lzywsgl}/role/updateRole.action";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些角色吗', function (index) {
                //向服务端发送删除指令
                $.post("${lzywsgl}/role/deleteBatchRole.action", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
